...
Exactly 524 bytes of 'crash' is needed in order to get us to EIP. Time to eddit our fuzzer and see if we can overwrite eip with some B's (/x42). 
...
## Conclusion and benefits
It was an opportunity to improve scripting skills
- scripting
- 
